...
Quick check of alignment results:

    head -n 5 ERR5743893.sam

**Note:** SAM header contains reference info; subsequent lines show read alignments.
